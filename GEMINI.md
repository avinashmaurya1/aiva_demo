# 🌊 Vibe Coding Workflow - Antigravity Agent Guidelines

Welcome to the **AIVA AI Agent Mobile** codebase. As an AI pair programmer in Antigravity, you MUST strictly adhere to the following Vibe Coding Workflow and project rules across every session.
